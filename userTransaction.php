            ...
            <div id="allTab" class="card">
                <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 20px;">
                 ...
                 <div style="margin: 20px 0; display: flex; gap: 10px;">
                    <button class="btn btn-delete" onclick="showTab('all')">All Transactions</button>
                    <button class="btn btn-view" onclick="showTab('sell')">My Sales</button>
                    <button class="btn btn-edit" onclick="showTab('buy')">My Purchases</button>
                </div>
