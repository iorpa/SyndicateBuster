...
\            <div class="header">
            ...
            <div class="nav-menu">
                ...
                <a href="PriceCap.php" style="background: rgba(255,255,255,0.1);">Price Caps</a>
            ...
            <div class="footer">
                ...
                <p style="font-size: 14px; color: #666; margin-top: 5px;">
                    Price Caps ensure fair market prices and prevent syndicate activities
                </p>
            </div>
        </div>
    </div>
